...
# Parameters for the RMTPP model
#  Data parameters
data_id = "amazon"
data_format = "pkl"
...
train_config_path = os.path.join(BASE_DIR, "RMTPP_train_config.yaml")
with open(train_config_path, "w") as f:
    yaml.dump(train_config, f)

# ====== 3. Run Training ======
print("Starting training...")
train_config = Config.build_from_yaml_file(train_config_path, experiment_id='RMTPP_train')
...
try:
    ...
    eval_config = {
        ...
        f"{model_id}_eval": {
            "base_config": {
                ...
                "out_config_dir": os.path.join(RESULTS_DIR, 'RMTPP_test_output.yaml')
            },
            "trainer_config": {
                "batch_size": batch_size,
                "max_epoch": 1,
            ...
            "model_config": {
                ...
                "seed": seed,
                "gpu": 0,
                "pretrained_model_dir": pretrained_model_path,
                "thinning": {
                    "num_seq": num_sequence,
                    "num_sample": num_sample,
                    "num_exp": num_exp,
    ...
    # Save eval config
    eval_config_path = os.path.join(BASE_DIR, "RMTPP_eval_config.yaml")
    with open(eval_config_path, "w") as f:
        yaml.dump(eval_config, f)

    # ====== 6. Run Evaluation ======
    print("Starting evaluation...")
    eval_config = Config.build_from_yaml_file(eval_config_path, experiment_id='RMTPP_eval')
